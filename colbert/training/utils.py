...
def print_progress(scores):
    ...
    print(f"positive_avg = {positive_avg}, negative_avg = {negative_avg}| {round(positive_avg - negative_avg, 2)}")
...
def manage_checkpoints(args, colbert, optimizer, batch_idx, savepath=None, consumed_all_triples=False):
    ...
    if consumed_all_triples or (batch_idx % 2000 == 0):
        ...
        path_save = os.path.join(checkpoints_path, f"colbert-{batch_idx}-finish")
