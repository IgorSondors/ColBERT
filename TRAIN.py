...
if __name__=='__main__':
    triples="/home/sondors/Documents/price/ColBERT_data/13_categories/train/triples_X1_13_categories_shuffle.json"
    queries="/home/sondors/Documents/price/ColBERT_data/13_categories/train/queries_train_13_categories.tsv"
    collection="/home/sondors/Documents/price/ColBERT_data/13_categories/train/documents_train_13_categories.tsv"
    # DocSettings:
    doc_maxlen=180
    dim=128
    ...
    with Run().context(RunConfig(nranks=1, experiment="HYPERPARAM_shuffle_13_categories_bsize1")): # nranks - число видеокарт
